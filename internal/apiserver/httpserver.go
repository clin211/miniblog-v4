...
import (
	...
	"github.com/clin211/miniblog-v4/internal/apiserver/handler"
	"github.com/clin211/miniblog-v4/internal/apiserver/pkg/metrics"
...
func (c *ServerConfig) NewGinServer() (*ginServer, error) {
	...
	engine.Use(
		...
		mw.Cors,
		mw.Secure,
		otelgin.Middleware("blog-apiserver", otelgin.WithFilter(func(rq *http.Request) bool {
...
func InstallGenericAPI(engine *gin.Engine) {
	...
	_ = metrics.Initialize(context.Background(), "blog-apiserver")
